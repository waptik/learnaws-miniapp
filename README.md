...
built on Celo blockchain with token rewards.
...
> [Complete Setup Guide](./docs/SETUP.md) for detailed installation
> instructions, environment configuration, and deployment steps.
...
2. **Set up environment variables:**
   - Web app: Create `apps/web/.env.local` (see
     [Web App ENV Setup](./apps/web/ENV_SETUP.md))
   - Contracts: Create `apps/contracts/.env` (see
...
For complete setup instructions, troubleshooting, and deployment guides, see the
...
- `pnpm phase1:fetch` - Fetch, parse, deduplicate, and save questions from
  GitHub (uses Bun)
...
- **[Complete Setup Guide](./docs/SETUP.md)** ⭐ - **Start here!** Complete
  installation, environment setup, and deployment guide
- [Web App Environment Setup](./apps/web/ENV_SETUP.md) - Web application
  environment variables
- [Contracts README](./apps/contracts/README.md) - Smart contract setup and
  deployment
- [Farcaster Setup](./docs/FARCASTER_SETUP.md) - Farcaster MiniApp integration
  guide
...
- [Implementation Plan](./docs/IMPLEMENTATION_PLAN.md) - Detailed architecture
  and implementation guide
- [Implementation Summary](./docs/IMPLEMENTATION_SUMMARY.md) - High-level
  overview
...
- [Results Display Specification](./docs/RESULTS_DISPLAY_SPEC.md) - Assessment
  results format
- [Question Types](./docs/QUESTION_TYPES.md) - Multiple choice and multiple

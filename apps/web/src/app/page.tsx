        ...
        <div className="w-full max-w-md mx-auto p-8 text-center">
          ...
          <div className="mb-6">
            <button
              ...
              className="w-full bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 disabled:bg-blue-400 dark:disabled:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
            >
              {isAddingMiniApp ? (
                <>
            ...
            {addMiniAppMessage && (
              <div className="mt-3 p-3 bg-white/30 dark:bg-gray-800/40 backdrop-blur-sm rounded-lg border border-white/30 dark:border-gray-700/50">

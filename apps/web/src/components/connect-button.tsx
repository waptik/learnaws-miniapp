...
export function WalletConnectButton() {
  ...
  // In platform (MiniApp or MiniPay): hide button when not connected, show menu when connected
  if (isInPlatform) {
    // Hide button when not connected in platform
    if (!isConnected) {
      return null;
    }
    // Show menu when connected in platform
    // For MiniPay (no username), show address-based menu
    // For MiniApp (has username), show username-based menu
    if (username) {
      // MiniApp with username - show full menu
      return (
        <DropdownMenu>
      ...
      // MiniPay (no username) - show address-based menu
      return (
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
